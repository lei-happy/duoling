...
CREATE TABLE `biz_dict_item` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_biz_dict_item_dict_id` (`dict_id`),
  KEY `ix_biz_dict_item_dict_code` (`dict_code`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='数据字典项表';