...
FEATURES = [
    ...
    {"feature_code": "biz_order", "feature_name": "运单管理", "module": "biz", "sort_order": 21, "required_tables": '["biz_order"]'},
    {"feature_code": "biz_dispatch", "feature_name": "调度管理", "module": "biz", "sort_order": 22, "required_tables": '["biz_order"]'},
    {"feature_code": "biz_tracking", "feature_name": "在途追踪", "module": "biz", "sort_order": 23, "required_tables": '["biz_order"]'},
    {"feature_code": "biz_receipt", "feature_name": "回单管理", "module": "biz", "sort_order": 24, "required_tables": '["biz_order"]'},
    # 财务模块 (pro 及以上)
