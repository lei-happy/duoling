...
MIGRATION_ID = "20260625_001"
MIGRATION_NAME = "capacity_operation_status"

REQUIRES_TABLES = ['biz_capacity']
...
def upgrade(conn, tenant_code: str) -> None:
    if not _col_exists(conn, "biz_capacity", "operation_status"):
        conn.execute(text(
            "ALTER TABLE `biz_capacity` ADD COLUMN `operation_status` SMALLINT NOT NULL DEFAULT 1 COMMENT '运力运营状态 1-可接单 2-运输中 3-休假 4-停运 5-维修保养'"
        ))
