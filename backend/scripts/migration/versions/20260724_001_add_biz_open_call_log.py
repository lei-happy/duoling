...
MIGRATION_ID = "20260724_001"
MIGRATION_NAME = "add biz_open_call_log"
...
def upgrade(conn, tenant_code: str) -> None:
    # NOTE: 新表 `biz_open_call_log` —— 推荐直接由 runner Phase 1 (feature.required_tables) 自动建表。
