...
MIGRATION_ID = "20260815_001"
MIGRATION_NAME = "energy station product"
...
def upgrade(conn, tenant_code: str) -> None:
    # NOTE: 新表 `biz_energy_station_product` —— 推荐直接由 runner Phase 1 (feature.required_tables) 自动建表。
