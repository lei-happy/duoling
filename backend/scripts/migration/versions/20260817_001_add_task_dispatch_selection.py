...
MIGRATION_ID = "20260817_001"
MIGRATION_NAME = "add task dispatch selection"
...
def upgrade(conn, tenant_code: str) -> None:
    # NOTE: 新表 `biz_task_dispatch_selection` —— 推荐直接由 runner Phase 1 (feature.required_tables) 自动建表。
