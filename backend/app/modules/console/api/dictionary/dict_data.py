...
from app.modules.console.schemas.dictionary.dict import DictDataCreate, DictDataUpdate
from app.modules.console.services.dictionary.dict_data_service import DictDataService
