...
from app.modules.console.schemas.dictionary.dict import DictCreate, DictUpdate
from app.modules.console.services.dictionary.dict_service import DictService
