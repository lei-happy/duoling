...
from app.modules.console.api.promotion import router as promotion_banner_router
...
router.include_router(promotion_banner_router, prefix="/promotion/banner", tags=["管理后台-推广位Banner"])
