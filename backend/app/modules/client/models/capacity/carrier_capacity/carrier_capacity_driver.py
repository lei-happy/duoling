...
与 biz_carrier_capacity 1:1 关联。字段与社会运力司机详情对称，
license_expire / qualification_expire 命名保持一致，便于证照监控统一扫描。
"""
...
class CarrierCapacityDriver(TenantModelBase):
    """承运商运力司机详情"""

    __tablename__ = "biz_carrier_capacity_driver"
    __table_args__ = {"comment": "承运商运力司机详情表"}
