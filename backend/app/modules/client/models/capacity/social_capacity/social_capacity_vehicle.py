...
与 biz_social_capacity 1:1 关联，存储车辆基础信息、规格、证照信息。
挂车信息以轻量内嵌方式存储，不再单独建挂车表。
"""
...
class SocialCapacityVehicle(TenantModelBase):
    """社会运力车辆详情"""

    __tablename__ = "biz_social_capacity_vehicle"
    __table_args__ = {"comment": "社会运力车辆详情表"}
