...
> - 同目录 [05.自有运力派车推荐](05.自有运力派车推荐.md)（待派车自有车：推荐列表 + 选择留痕）
...
- **自有车 / 社会运力待派车 / 换车**：弹窗主路径是带理由的运力列表，只选不填。社会运力档案在运力中心维护。契约与留痕见 [05.自有运力派车推荐](05.自有运力派车推荐.md)
- 状态推进通过 API 或前端按钮触发：
...
| 智能调度 / 自有运力推荐 | 派车交互与 `heuristic_v1` 已落地；模型替换见 [05.自有运力派车推荐](05.自有运力派车推荐.md)。任务单 `source=2` 仍预留配载采纳来源 |
