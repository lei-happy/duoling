...
工单号、车辆、类型 repair/maintenance、计划 id、标题、里程、维修厂、费用、状态 draft/in_progress/completed/cancelled、started_at/finished_at、capacity_id、审计字段。
...
看板、工单 CRUD/开工完工取消、计划 CRUD/生成工单；二期资产卡片与 cost summary/details。
