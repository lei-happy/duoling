...
| 阶段 | 产出物 | 涉及目录 |
|------|--------|----------|
| 需求设计 | 需求文档、表结构设计 | `doc/02.需求文档/`、`doc/03.数据库设计/` |
...
在 `doc/03.数据库设计/02.租户库数据表/` 下创建表结构 SQL：

```sql
-- 文件：doc/03.数据库设计/02.租户库数据表/biz_fuel_card.sql
...
| 操作 | 文件路径 |
|------|----------|
| 新建 | `doc/02.需求文档/资源管理-油卡管理.md` |
| 新建 | `doc/03.数据库设计/02.租户库数据表/biz_fuel_card.sql` |
