...
console.log('');
console.log('提示：构建完成后可删除 node_modules，只保留 miniprogram_npm，');
console.log('可避免微信开发者工具 EMFILE（too many open files）。');
console.log('需要重建时再执行：npm install && npm run build:npm');
