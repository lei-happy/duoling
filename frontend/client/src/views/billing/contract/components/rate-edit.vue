...
<script lang="ts" setup>
  ...
  const buildConflictPayload = () => {
    ...
    return {
      ...
      originRegionId: f.originRegionId ?? null,
      originCode: f.originCode ?? null,
      destinationRegionId: f.destinationRegionId ?? null,
      destinationCode: f.destinationCode ?? null,
      brandId: f.brandId ?? null,
      seriesId: f.seriesId ?? null,
      priority: f.priority ?? 0,
      priceType: f.priceType ?? 0,
      isBidirectional: f.isBidirectional ?? 0,
