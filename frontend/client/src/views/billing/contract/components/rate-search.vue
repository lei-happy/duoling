...
<script lang="ts" setup>
  ...
  import type { FreightRateFilterParam } from '@/api/billing/contract/model';

  const emit = defineEmits<{
    (e: 'search', where?: FreightRateFilterParam): void;
  }>();

  const [form, resetFields] = useFormData<FreightRateFilterParam>({
    keyword: '',
    billingMode: void 0,
    priceType: void 0,
    status: void 0
