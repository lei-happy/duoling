...
<script lang="ts" setup>
  ...
  > = {
    revenue: {
      title: '计划运费',
      tooltip:
        '统计当天 0 点至接口返回时刻的计划应收运费合计（客户结算口径）；主数字单位为万元；迷你图为近 30 天每日运费（元）。未扣除运输等环节成本，不等同于公司收入。',
      display: 'wan',
      color: '#165dff',
      chartType: 'line'
    },
    waybillCount: {
      title: '计划数',
      tooltip:
        '统计当天 0 点至接口返回时刻的计划条数，单位为「单」；迷你图为近 30 天每日计划量。',
      display: 'int',
      mainUnit: '单',
      color: '#14c9c9',
      chartType: 'bar'
    ...
    customerCount: {
      title: '服务客户数',
      tooltip:
        '统计当天 0 点至接口返回时刻、有计划的去重客户数，单位为「家」；迷你图为近 30 天每日去重客户数。',
      display: 'int',
      mainUnit: '家',
      color: '#ff7d00',
      chartType: 'bar'
